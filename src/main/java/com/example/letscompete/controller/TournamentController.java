...
public class TournamentController {
    ...
    @PostMapping
    public ResponseEntity<TournamentDTO> addNewTournament(@RequestBody @Valid Tournament tournament){
    ...
    public ResponseEntity<TournamentDTO> addTournamentTeam(@PathVariable int tournamentId,@RequestParam int teamId){return ResponseEntity.ok(tournamentService.addTeam(tournamentId,teamId));}

    @DeleteMapping("/{tournamentId}/teams")
    public ResponseEntity<TournamentDTO> removeTournamentTeam(@PathVariable int tournamentId,@RequestParam int teamId){return ResponseEntity.ok(tournamentService.deleteTeamById(tournamentId,teamId));}
    ...
    public ResponseEntity<TournamentDTO> replaceTournamentLocation(@PathVariable int tournamentId,@RequestParam int locationId){return ResponseEntity.ok(tournamentService.changeTournamentLocation(tournamentId,locationId));}

    @DeleteMapping("/{tournamentId}/location")
    public ResponseEntity<TournamentDTO> removeTournamentLocation(@PathVariable int tournamentId){return ResponseEntity.ok(tournamentService.deleteLocation(tournamentId));}
    ...
    public ResponseEntity<TournamentDTO> replaceTournamentGame(@PathVariable int tournamentId,@RequestParam int gameId){return ResponseEntity.ok(tournamentService.changeTournamentGame(tournamentId,gameId));}

    @DeleteMapping("/{tournamentId}/game")
    public ResponseEntity<TournamentDTO> removeTournamentGame(@PathVariable int tournamentId){return ResponseEntity.ok(tournamentService.deleteGame(tournamentId));}
    ...
    public ResponseEntity<TournamentDTO> addTournamentSponsor(@PathVariable int tournamentId,@RequestParam int sponsorId){return ResponseEntity.ok(tournamentService.addTournamentSponsor(tournamentId,sponsorId));}

    @DeleteMapping("/{tournamentId}/sponsors")
    public ResponseEntity<TournamentDTO> removeTournamentSponsor(@PathVariable int tournamentId, @RequestParam int sponsorId){return ResponseEntity.ok(tournamentService.deleteSponsorById(tournamentId,sponsorId));}
